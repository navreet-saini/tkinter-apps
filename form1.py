...
def saving():
    ...
    cr.execute(f"insert into contact(full_name, email_add, phone_no, message) values('{full_nm}', '{email}', '{phone}', '{msg}');")
...
btn = tk.Button(frame6, text = "Send Message", font = ("robort", 16, "bold"), bg = "#33850b", fg = "#68f522", command = saving)
btn.pack()

showinfo = tk.Label(frame6, text = "", font = ("robort", 16, "bold"), bg = "#68f522", fg = "#184700")
